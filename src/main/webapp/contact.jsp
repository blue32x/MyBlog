...
<html lang="en">
  ...
  <head>
    ...
    <!-- Custom fonts for this template -->
     <link rel="${pageContext.request.contextPath}/resource/vendor/fontawesome-free/css/all.min.css">
    <link href='https://fonts.googleapis.com/css?family=Lora:400,700,400italic,700italic' rel='stylesheet' type='text/css'>
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800' rel='stylesheet' type='text/css'>

    <!-- Custom styles for this template -->
  <link rel="${pageContext.request.contextPath}/resource/css/clean-blog.min.css">
  ...
  <body>
    ...
    <!-- Page Header -->
    <header class="masthead" style="background-image: url('${pageContext.request.contextPath}/resource/img/contact-bg.jpg')">
...
<!--     <script src="/resources/js/clean-blog.min.js"></script> -->
    <script src="<c:url value="/resource/js/clean-blog.min.js" />"></script>
